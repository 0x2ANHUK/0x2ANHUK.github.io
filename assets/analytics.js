...
(function(){
  // Collector URL: default to conn domain; override by setting window.ANALYTICS_COLLECTOR
  var collector = (window.ANALYTICS_COLLECTOR) ? window.ANALYTICS_COLLECTOR : 'https://conn.ktano-studio.com/collect';
